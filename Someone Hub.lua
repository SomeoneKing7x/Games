    ...
    while wait() do
        pcall(function()
            if _G.Autofruit then
                local fruits = {"Blade-Blade", "Spring-Spring", "Bomb-Bomb",
                    "Smoke-Smoke", "Spike-Spike", "Flame-Flame", "Ice-Ice", "Sand-Sand",
                    "Dark-Dark", "Ghost-Ghost", "Diamond-Diamond", "Light-Light", "Rubber-Rubber", "Magma-Magma"
                }
...
local prgMoon = Race:AddParagraph({
    ...
    while true do
        ...
        if moon == "rbxassetid://9709172792" then -- 🌘
            prgMoon:SetTitle("Current Moon : 🌘")
            prgMoon:SetDesc("🌗 🌖 🌕 🌔 🌓 🌒 🌑")
        elseif moon == "rbxassetid://9709172305" then -- 🌗
            prgMoon:SetTitle("Current Moon : 🌗")
            prgMoon:SetDesc("🌖 🌕 🌔 🌓 🌒 🌑 🌘")
        elseif moon == "rbxassetid://9709171885" then -- 🌖
            prgMoon:SetTitle("Current Moon : 🌖")
            prgMoon:SetDesc("🌕 🌔 🌓 🌒 🌑 🌘 🌗")
        elseif moon == "rbxassetid://9709171537" then -- 🌕
            prgMoon:SetTitle("Current Moon : 🌕")
            prgMoon:SetDesc("🌔 🌓 🌒 🌑 🌘 🌗 🌖")
        elseif moon == "rbxassetid://9709171062" then -- 🌔
            prgMoon:SetTitle("Current Moon : 🌔")
            prgMoon:SetDesc("🌓 🌒 🌑 🌘 🌗 🌖 🌕")
        elseif moon == "rbxassetid://9709170691" then -- 🌓
            prgMoon:SetTitle("Current Moon : ??")
            prgMoon:SetDesc("🌒 🌑 🌘 🌗 🌖 🌕 🌔")
        elseif moon == "rbxassetid://9709170197" then -- 🌒
            prgMoon:SetTitle("Current Moon : 🌒")
            prgMoon:SetDesc("🌑 🌘 🌗 🌖 🌕 🌔 🌓")
        elseif moon == "rbxassetid://9709169431" then -- 🌑
            prgMoon:SetTitle("Current Moon : 🌑")
            prgMoon:SetDesc("🌘 🌗 🌖 🌕 🌔 🌓 🌒")
        end
    end
...
imagem = Instance.new("ImageLabel", game.Players.LocalPlayer.PlayerGui:WaitForChild("ScreenGui")) imagem.Size = UDim2.new(0, 75, 0, 75) imagem.Image = ""
...
spawn(function()
    while true do
        ...
        if _G.AutoKillPlayerTrial then
            repeat
                if _G.PlayerHunter and _G.PlayerHunter.Character and _G.PlayerHunter.Character:FindFirstChild("HumanoidRootPart") and _G.PlayerHunter.Character:FindFirstChild("Humanoid") then
