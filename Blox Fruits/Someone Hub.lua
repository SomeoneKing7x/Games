	...
	spawn(function()
	    while true do
	      task.wait()
	        ...
	        if workspace.Characters[game:GetService("Players").LocalPlayer.Name].RaceEnergy.Value <= 0.4 and workspace.Characters[game:GetService("Players").LocalPlayer.Name].RaceTransformed.Value then
	       game:GetService("Players").LocalPlayer.Character.Humanoid.Health = 0
              ...
              if _G.AutoFarmBones and workspace.Characters[game:GetService("Players").LocalPlayer.Name].RaceTransformed.Value then
              repeat
              task.wait()
              _G.AutoFarmBones = false
              UnequipTool(SelectWeapon)
              until not workspace.Characters[game:GetService("Players").LocalPlayer.Name].RaceTransformed.Value
              end
              if not _G.AutoTrainRace then
              _G.AutoFarmBones = false
              end
              end
	       end
